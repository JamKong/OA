...
<script type="text/javascript">
	...
	<body>
	<div id="page_title" ><img src="style/images/youjiantou.png"> [ ${topic.forum.name } ]中的发表新主题</div>
	<div>
		<img src="style/images/lubiao.png">
		<s:a action="forum_list">论坛</s:a>
		<img src="style/images/lubiao.png">
		<s:a action="forum_show?forumId=%{#forum.id}">${topic.forum.name }</s:a>
		<img src="style/images/lubiao.png">
		修改主题
	</div>
	<s:form action="topic_update" method="post">
	<input type="hidden" name="id" value="${topic.id }"/>
	<table> 
		<tr>
			<td class="td_title">标题</td>
			<td><input type="text" name="model.title" class="td_content" value="${topic.title }" /></td>
		</tr>
		<tr>
			<td class="td_title">内容</td>
			<td><textarea rows="20" cols="80" name="model.content" id="replyContent" class="ckeditor">${topic.content }</textarea></td>
		</tr>
		<tr>
